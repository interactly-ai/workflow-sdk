...
| 13 | [Choosing LLM providers](./wf_example_progression_13.md) | Configure nodes to use alternative model providers (Azure / Google / Anthropic) and a platform default. | provider LLM configs, WorkflowDefaultLLMConfig, per-node model selection |
